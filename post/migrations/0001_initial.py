    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_file', models.FileField(blank=True, upload_to='post/')),
                ('audio_duration', models.CharField(blank=True, max_length=128, null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', models.FileField(blank=True, upload_to='post/')),
                ...
                ('youtube_url', models.CharField(blank=True, max_length=128)),
                ...
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='post.region')),
                ('tag', models.ManyToManyField(blank=True, null=True, related_name='posts', to='post.tag')),
            ],
            options={
                'abstract': False,
            },
